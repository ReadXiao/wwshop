...
<div class="banner_x center">
    ...
    <div class="wdgwc fl ml40">优惠券领取</div>
    <div class="wxts fl ml20">温馨提示：优惠券在有效期内才有效哦，领取后请尽快使用</div>
    <div class="dlzc fr">
        <ul>
            <li><a href="../../index.jsp">首页</a></li>
            <li>|</li>
            <li><a href="#" onclick="myCoupon()">我的优惠卷</a></li>
        </ul>
            ...
            <li>
                <div class="cone">
                    ...
                    <div class="d3">
                        ...
                        <button onclick="getCoupon('${validCoupon.minPrice}','${validCoupon.discountPrice}','${validCoupon.deadline}','${validCoupon.catalogId}','${validCoupon.id}')">点击领取</button>
                    </div>
                </div>
            </li>
        </c:forEach>
