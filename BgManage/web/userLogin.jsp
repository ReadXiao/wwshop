...
<head>
    ...
    <script src="static/js/userLogin.js" type="text/javascript"></script>
</head>
    ...
    <div class="col-md-12">
        ...
        <form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form">
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="control-wrapper">
                        <input type="button" value="登录" class="btn btn-info" id="userLogin">
                        <a href="userForgot-password.jsp" class="text-right pull-right">忘记密码？</a>
                    </div>
                </div>
            </div>
            <hr>
        ...
        <div class="text-center">
            <a href="userRegist.jsp" class="templatemo-create-new"><i class="glyphicon glyphicon-hand-right"></i>&nbsp;注册</a>
        </div>
    </div>
</div>
</body>
